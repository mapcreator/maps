...
<head>
  ...
  <script type="text/javascript" src="js/jquery.ui.rotatable.js"></script>  -->
    ...
    <!-- COLORPICKER -->
    <link rel="stylesheet" media="screen" type="text/css" href="js/colorpicker/jquery.minicolors.css" />
    <script type="text/javascript" src="js/colorpicker/jquery.minicolors.js"></script>
